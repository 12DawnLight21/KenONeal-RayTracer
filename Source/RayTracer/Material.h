...
public:
	...
	bool Scatter(const ray_t& ray, const raycastHit_t& raycastHit, Color::color3_t& color, ray_t& scattered) const override; //<override the parent Scatter() method>
...
{
public:
	Emissive(const Color::color3_t& albedo, float intensity = 1) : m_albedo{ albedo }, m_intensity{intensity} {} //<set albedo>, <set intensity>
	...
	Color::color3_t GetEmissive() const override { return m_albedo * m_intensity; } // <multiply albedo by intensity>
